...
FROM docker.io/library/python:3.14.1-bookworm AS compile-stage
...
# This is the latest version of pipenv available for Python 3.11.8.
...
# Official Docker images are in the form library/<app> while non-official
# images are in the form <user>/<app>.
FROM docker.io/library/python:3.14.1-bookworm AS build-stage
