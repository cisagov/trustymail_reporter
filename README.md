...
```console
docker run cisagov/trustymail_reporter:1.4.8
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/trustymail_reporter:1.4.8
    ```
...
|-----------|-------------|
|`cisagov/trustymail_reporter:1.4.8`| An exact release version. |
...
```console
docker build \
  --tag cisagov/trustymail_reporter:1.4.8 \
