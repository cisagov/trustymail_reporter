...
```console
docker run cisagov/trustymail_reporter:1.4.9
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/trustymail_reporter:1.4.9
    ```
...
|-----------|-------------|
|`cisagov/trustymail_reporter:1.4.9`| An exact release version. |
...
```console
docker build \
  --tag cisagov/trustymail_reporter:1.4.9 \
