...
```console
docker run cisagov/trustymail_reporter:1.5.5
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/trustymail_reporter:1.5.5
    ```
...
|-----------|-------------|
|`cisagov/trustymail_reporter:1.5.5`| An exact release version. |
...
```console
docker build \
  --tag cisagov/trustymail_reporter:1.5.5 \
